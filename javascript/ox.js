...
function _quizInit(){
	...
	// 결과 페이지 초기화
		for(i=1;i<quizDap.length;i++){
				if (i == 1) {
					$("#resq_"+i).css({"background":"url(../common/img/quiz/result_q"+i+"_no.png)", 'background-repeat' : 'no-repeat', 'top':'315px','left':'158px'}); 
				} else if (i == 2) {
					$("#resq_"+i).css({"background":"url(../common/img/quiz/result_q"+i+"_no.png)", 'background-repeat' : 'no-repeat', 'top':'315px','left':'310px'}); 
				} else if (i == 3) {
					$("#resq_"+i).css({"background":"url(../common/img/quiz/result_q"+i+"_no.png)", 'background-repeat' : 'no-repeat', 'top':'315px','left':'462px'}); 
				} else if (i == 4) {
					$("#resq_"+i).css({"background":"url(../common/img/quiz/result_q"+i+"_no.png)", 'background-repeat' : 'no-repeat', 'top':'315px','left':'614px'}); 
				} else if (i == 5) {
					$("#resq_"+i).css({"background":"url(../common/img/quiz/result_q"+i+"_no.png)", 'background-repeat' : 'no-repeat', 'top':'315px','left':'766px'}); 
				}
		}
}
...
function _endAct(){
	...
	for(i=1;i<quizDap.length;i++){
		if(myArray[i] == quizDap[i]){
			...
			$("#resq_"+i).addClass("oo");
			if (i == 1) {
				$("#resq_"+i).css({"background":"url(../common/img/quiz/result_q"+i+"_ok.png)", 'background-repeat' : 'no-repeat', 'top':'315px','left':'158px'}); 
			} else if (i == 2) {
				$("#resq_"+i).css({"background":"url(../common/img/quiz/result_q"+i+"_ok.png)", 'background-repeat' : 'no-repeat', 'top':'315px','left':'310px'}); 
			} else if (i == 3) {
				$("#resq_"+i).css({"background":"url(../common/img/quiz/result_q"+i+"_ok.png)", 'background-repeat' : 'no-repeat', 'top':'315px','left':'462px'}); 
			} else if (i == 4) {
				$("#resq_"+i).css({"background":"url(../common/img/quiz/result_q"+i+"_no.png)", 'background-repeat' : 'no-repeat', 'top':'315px','left':'614px'}); 
			} else if (i == 5) {
				$("#resq_"+i).css({"background":"url(../common/img/quiz/result_q"+i+"_no.png)", 'background-repeat' : 'no-repeat', 'top':'315px','left':'766px'}); 
